...
public class Bank extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField6.setText("NAJJUMA");
        jTextField6.addActionListener(this::jTextField6ActionPerformed);

        jTextField7.setText("JAMIRAH");

        jTextField8.setText("CF5623246675TRHLM");
        jTextField8.addActionListener(this::jTextField8ActionPerformed);

        jTextField9.setText("jamirahnajjuma@gmail.com");
        jTextField9.addActionListener(this::jTextField9ActionPerformed);

        jTextField10.setText("jamirahnajjuma@gmail.com");
        ...
        jTextField19.setText("+256748453436");
